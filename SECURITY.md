...
- Privacy Filter integration is local-sidecar only; server-side redaction is intentionally not used in the public demo. The privacy-bundled desktop artifact starts an embedded loopback sidecar from packaged model weights.
